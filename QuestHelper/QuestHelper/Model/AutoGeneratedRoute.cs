...
namespace QuestHelper.Model
{
    internal class AutoGeneratedRoute
    {
        ...
        public AutoGeneratedRoute(IImageManager imageManager)
        {
        ...
        internal void BuildOld(List<ViewLocalFile> listCachedImages)
        {
            ...
            foreach (var image in sortedByTime)
            {
                if (!image.Processed)
                {
                    ...
                    AutoGeneratedPoint point = new AutoGeneratedPoint() { Name = image.FileNameDate.ToString(), CreateDate = image.FileNameDate.DateTime, Longitude = longitude, Latitude = latitude };

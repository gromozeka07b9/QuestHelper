...
{
    public class PointCarouselRootViewModel : INotifyPropertyChanged
    {
        ...
        public PointCarouselRootViewModel(string routeId, string routePointId, string routePointMediaId)
        {

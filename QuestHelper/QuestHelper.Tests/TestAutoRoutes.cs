...
namespace QuestHelper.Tests
{
    public class TestAutoRoutes
    {
        ...
        public void TestMust_Get3RoutePointsWith2PhotosEach_Old()
        {
            ...
            testPhotos.Add(new ViewLocalFile(){Latitude = 1, Longitude = 1, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            testPhotos.Add(new ViewLocalFile(){Latitude = 1, Longitude = 1, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            testPhotos.Add(new ViewLocalFile(){Latitude = 2, Longitude = 2, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            testPhotos.Add(new ViewLocalFile(){Latitude = 2, Longitude = 2, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            testPhotos.Add(new ViewLocalFile(){Latitude = 3, Longitude = 3, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            testPhotos.Add(new ViewLocalFile(){Latitude = 3, Longitude = 3, CreateDate = DateTime.Parse("2020/07/01"), FileNameDate = DateTime.Parse("2020/07/01")});
            //Act
            AutoGeneratedRouted autoRoute = new AutoGeneratedRouted(new ImageManager());
